...
export const modelsListResponse = {
    object: 'list',
    data: [
        { id: 'grok-4', object: 'model', created: 1704067200, owned_by: 'xai' },
        { id: 'grok-4-fast', object: 'model', created: 1704067200, owned_by: 'xai' },
        { id: 'grok-code-fast-1', object: 'model', created: 1704067200, owned_by: 'xai' },
        { id: 'grok-4.1-fast', object: 'model', created: 1704067200, owned_by: 'xai' },
    ],
};
