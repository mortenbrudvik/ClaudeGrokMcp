...
import { executeEstimateCost, handleEstimateCost, estimateTokens, estimateCostSchema, compareModelCosts, } from './estimate-cost.js';
describe('grok_estimate_cost tool', () => {
    describe('estimateTokens', () => {
        ...
        it('should estimate tokens for longer text', () => {
            const longText = 'This is a longer piece of text that should result in more tokens being estimated for the cost calculation.';
    ...
    describe('executeEstimateCost', () => {
        ...
        it('should include context in token estimation', () => {
            ...
            expect(resultWith.estimated_input_tokens).toBeGreaterThan(resultWithout.estimated_input_tokens);
        });
        ...
        it('should estimate more output for code queries', () => {
            ...
            expect(codeResult.estimated_output_tokens).toBeGreaterThan(simpleResult.estimated_output_tokens);
        });
        it('should provide cost breakdown', () => {
            ...
            expect(result.breakdown.input_cost_usd + result.breakdown.output_cost_usd).toBeCloseTo(result.estimated_cost_usd, 10);
        });
        ...
        it('should calculate total tokens correctly', () => {
            ...
            const result = executeEstimateCost(input);
            expect(result.estimated_total_tokens).toBe(result.estimated_input_tokens + result.estimated_output_tokens);
        });
    });
...
//# sourceMappingURL=estimate-cost.test.js.map