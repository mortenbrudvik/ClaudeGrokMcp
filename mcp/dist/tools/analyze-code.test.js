...
import { executeAnalyzeCode, handleAnalyzeCode, detectLanguage, analyzeCodeSchema, } from './analyze-code.js';
describe('grok_analyze_code tool', () => {
    ...
    describe('handleAnalyzeCode', () => {
        ...
        it('should return error for missing code', async () => {
            ...
            expect(result.isError).toBe(true);
            expect(result.content[0].text).toContain('code property is required');
        });
...
//# sourceMappingURL=analyze-code.test.js.map