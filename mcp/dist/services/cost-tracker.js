...
export class CostLimitExceededError extends Error {
    ...
    constructor(currentCost, limit, estimatedCost) {
        super(`Cost limit exceeded: Current session cost is $${currentCost.toFixed(4)} of $${limit.toFixed(2)} limit. ` +
 ...
 */
export function getDefaultCostTrackerOptions() {
    return {
...
export class CostTracker {
    ...
    getUsageSummary() {
        ...
        const budgetUsedPercent = this.options.limitUsd > 0
 ...
 */
export function getDefaultCostTracker() {
 ...
 */
export function resetDefaultCostTracker() {
