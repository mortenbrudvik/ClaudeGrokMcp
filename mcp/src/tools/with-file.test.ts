...
describe('grok_with_file tool', () => {
  ...
  describe('validateGrokWithFileInput', () => {
    ...
    describe('error cases', () => {
      ...
      it('should reject missing query', () => {
        expect(() => validateGrokWithFileInput({ file_content: 'content' })).toThrow(
          'query is required'
        );
      });

      it('should reject empty query', () => {
        expect(() => validateGrokWithFileInput({ query: '', file_content: 'content' })).toThrow(
      ...
      it('should reject missing file_content', () => {
        expect(() => validateGrokWithFileInput({ query: 'What is this?' })).toThrow(
      ...
      it('should reject empty file_content', () => {
        expect(() =>
          validateGrokWithFileInput({ query: 'What is this?', file_content: '' })
        ).toThrow('file_content cannot be empty');
      });
  ...
  describe('handleGrokWithFile', () => {
    ...
    it('should work with services', async () => {
      ...
      const result = await handleGrokWithFile(client, input, mockServices as any);
