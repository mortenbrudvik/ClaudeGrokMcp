...
```
/design-review <design_description>
```
...
```
/design-review Should we use microservices or a monolith for our new auth service?
/design-review What's the best way to implement caching for our API?
/design-review Review our database schema design for the user management system
/design-review Compare Redux vs Context API for our React app state management
```
...
- `/review-with-grok` - Code-level review
- `/debug-with-grok` - Problem diagnosis
